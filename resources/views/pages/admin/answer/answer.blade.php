        ...
        <div class="">
                ...
                <div class="block w-1/2 max-md:w-full">
                    <div class="block my-4">
                        ...
                        <div class="flex gap-2 items-center">
                            ...
                            <p class="items-center text-[#628ECB] font-semibold">{{ $participant->user->name }}
                            </p>
                        </div>
                    </div>
                    <div class="block my-4">
                        ...
                        <div class="flex gap-2">
                            ...
                            <p class="items-center text-[#628ECB] font-semibold">{{ $survey->title }}</p>
                        </div>
                    </div>
                </div>
                <div class="block  w-1/2 max-md:w-full">
                    <div class="block my-4">
                        ...
                        <div class="flex gap-2 items-center">
                            ...
                            <p class="items-center text-[#628ECB] font-semibold">
            ...
            <div class="my-4 ms-1">
                @foreach ($answers as $key => $answer)
                    <div class="block border-2 border-primary lg:p-8 max-lg:p-2 rounded-xl mt-16">
