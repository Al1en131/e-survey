        ...
        <div class="">
                    ...
                    <div class="block w-1/2 max-md:w-full">
                        <div class="block my-4">
                            ...
                            <div class="flex gap-2 items-center">
                                <div class="w-6"><svg xmlns="http://www.w3.org/2000/svg" width="22"
                                        height="22" viewBox="0 0 20 20" fill="none" class="">
                                ...
                                <p class="items-center ">{{ $participant->user->name }}
                                </p>
                            </div>
                        </div>
                        <div class="block my-4">
                            <p class="text-lg mb-1 font-semibold">Survey Name :</p>
                            <div class="flex gap-2">
                                ...
                                <p class="items-center">{{ $survey->title }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="block  w-1/2 max-md:w-full">
                        <div class="block my-4">
                            <p class="text-lg mb-1 font-semibold">Date Start :</p>
                            <div class="flex gap-2 items-center">
                                <div class="w-6"><svg xmlns="http://www.w3.org/2000/svg" width="21"
                                        height="21" viewBox="0 0 20 20" fill="none" class="">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="block my-4">
                            <p class="text-lg mb-1 font-semibold">Survey Start :</p>
                            <div class="flex gap-2 items-center">
                                <div class="w-6"><svg xmlns="http://www.w3.org/2000/svg" width="18"
                                        height="18" viewBox="0 0 16 16" fill="none" class="">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <div class=" ms-1">
                @foreach ($answers as $key => $answer)
                    <div class="block border-2 border-primary lg:p-8 max-lg:p-2 rounded-xl mt-10">
                        <div class="flex relative">
                            <p
                                class="text-sm text-white rounded-full font-bold w-9 h-9 py-2 text-center absolute bg-secondary">
                                {{ $key + 1 }}
                            </p>
                            <div class="ml-16">
                                @if ($answer->question->getFirstMediaUrl('question'))
                                    <img class="max-w-md rounded-xl mb-6 max-md:max-w-40"
                                ...
                                <div class="flex flex-wrap gap-10 mt-6">
                                    @for ($j = 1; $j <= $answer->question->option->first()->option; $j++)
                                        @if ($answer->answerable->likert == $j)
                                            <button
                                                class="flex w-fit items-center justify-center rounded-xl bg-primary p-6 border-2 border-[#C1E5FF]"
                                                type="button">
                                                <span
                                                    class="rounded-half flex h-[46px] w-[46px] items-center justify-center border-4 border-[#C1E5FF] text-[#C1E5FF] text-2xl font-semibold">
                                                    {{ $j }}
                                                </span>
                                            </button>
                                        @else
                                            <button
                                                class="flex w-fit items-center justify-center rounded-xl bg-gray-200 p-6 border-2 border-primary"
                                                type="button">
                                                <span
