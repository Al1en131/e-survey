        ...
        <div class="max-w-full flex-grow">
            ...
            <div class="mb-8 px-8 py-2 bg-primary flex items-center gap-12 rounded-lg">
                ...
                <div class="text-white">
                    <h2 class="text-xl font-semibold mb-2">Survey Data</h2>
                    <p class="text-sm leading-relaxed max-w-2xl">
                        This page contains a collection of surveys that have been created and managed by administrators.
                        These surveys are designed to gather valuable feedback, assess specific topics, and support
            ...
            <div class="text-gray-900">
                <div class="relative sm:rounded-lg">
                    <div class="overflow-x-auto rounded-xl">
                                ...
                                @foreach ($surveys as $survey)
                                    <tr
                                        ...
                                        <td class="px-6 py-4 w-12 content-center">
                                            <a href="#"
                                                class="bg-primary px-4 py-3 flex gap-2 items-center text-white rounded-lg text-nowrap copy-button w-full"
                                                data-slug="{{ config('app.url') . '/' . 'survey/' . $survey->slug }}">
                                                <span>
                                        ...
                                        <td class="px-6 py-4 content-center w-10">
                                            <div class="w-full flex justify-around">
                                                <a href="{{ route('admin.survey.edit', ['id' => $survey->id]) }}"
                                                    class="text-warning">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                        class="w-6 h-6">
                                                ...
                                                <a href="#" class="delete text-red-600"
                                                    data-id="{{ $survey->id }}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                        class="w-6 h-6">
                        ...
                        <div id="error-message" class="text-red-600 hidden mt-3 text-center">Enter the name of the
                            survey correctly</div>
                    </div>
                </div>
            </div>
        </div>
